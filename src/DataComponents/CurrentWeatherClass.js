...
export default function createCurrentWeather(locationName, mainIcon, forecastText, description, cloudiness, temperature, pressure, humidity, visibility, rain, windspeed) {
    return new CurrentWeather(locationName, mainIcon, forecastText, description, cloudiness, temperature, pressure, humidity, visibility, rain, windspeed);
}
...
class CurrentWeather {
    constructor(locationName, mainIcon, forecastText, description, cloudiness, temperature, pressure, humidity, visibility, rain, windspeed) {
        ...
        temperature === undefined ? this.temperature = "N/A" : this.temperature = temperature;
